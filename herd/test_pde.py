...
def rhs(Y, t, AM, B, force_of_infection, force_of_infection_carriers,
        progression_rate, recovery_rate, proportion_carriers, immunity_waning_rate,
...
def solve(tmax, agemax, agestep, parameters, Y0 = None):
    ...
    waning_immunity_rate = 1 / parameters.waning_immunity
