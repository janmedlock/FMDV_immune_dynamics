...
\begin{subequations}
  ...
  \end{align}
\end{subequations}
\textbf{TODO: For continuity, should (15g) be
  $$p_{\mathrm{I}}^0
  = p_{\text{progression}}(0) p_{\mathrm{E}}^0 \Delta a,$$
  (15i) be
  $$p_{\mathrm{C}}^0
  = p_{\text{chronicity}} p_{\text{recovery}}(0) p_{\mathrm{I}}^0 \Delta a,$$
  and (15k) be
  $$P_{\mathrm{R}}^0
  = (1 - p_{\text{chronicity}})
  p_{\text{recovery}}(0) p_{\mathrm{I}}^0 \Delta a^2
  + p_{\text{chronic recovery}}(0) p_{\mathrm{C}}^0 \Delta a^2?$$
  Or should the sums in (15h), (15j), and (15l) start at $i = 1$?
  If so, then should the sums in (16) start at $i = 1$?}
with
\begin{subequations}
...
\begin{subequations}
  \begin{align}
    ...
    \begin{split}
      ...
      + p_{\mathrm{E}}^0
      \\ {}
      - h_{\text{infection}} P_{\mathrm{L}}^0
      &= 0,
    \end{split}
    \displaybreak[0]\\
    \begin{split}
...
\begin{subequations}
  \begin{align}
    ...
    f_{\mathrm{ES}}^i &=
    \begin{cases}
      h_{\text{infection}} & \text{for $i \in \{0\}$},
      \\
  ...
  \end{align}
\end{subequations}
\textbf{TODO: Should the $\bar{f}_{XY}^{0, 0}$ follow the same formula
  as $i > 0$?}
