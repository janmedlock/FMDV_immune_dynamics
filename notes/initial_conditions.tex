...
For given hazard of infection, $h_{\text{infection}}$,
and fraction of newborns with maternal immunity,
$\phi_{\text{maternal immunity}}$, we will find the equilibrium
...
We will use these $P_X(a)$ and $p_X(a, r)$ to iteratively find the
fixed point for $h_{\text{infection}}$ and
$\phi_{\text{maternal immunity}}$ and, finally, the equilibrium
densities $P_X(a)$ at this fixed point.
...
\textbf{TODO: \eqref{eq:sums_differences} should look like
  \eqref{eq:integrals_derivatives}. In particular, the last sum should
