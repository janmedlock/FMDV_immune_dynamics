...
\author{
  Jan Medlock \and Ricardo Noé Gerardo Reyes Grimaldo
...
\begin{figure}
  \centering
  \input{diagram}
  \caption{Model diagram. The dashed box and arrows are the new
    components added to the previous model of \textcite{jolles_2021}.}
  \label{model_diagram}
\end{figure}
