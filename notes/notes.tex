...
\item[Death] On the birth of new buffalo calf, the age at death of
  that calf is sampled from its distribution.
...
\begin{equation}
  ...
  \end{cases}
\end{equation}
Assuming that the hazard of death is constant throughout a year gives
the hazard
\begin{equation}
  h_{\text{death}}(a)
...
\begin{equation}
  ...
  \begin{split}
    ...
    & \quad\quad\quad\quad\quad {} +
      \int_0^{\infty} n_0(a)
      \frac{S_{\text{death}}(a + t)}{S_{\text{death}}(a)}
...
\begin{equation}
  n(t, a) =
  \begin{cases}
    B(t - a) S_{\text{death}}(a)
    & \text{if $a < t$},
    \\
    n_0(a - t)
    \frac{S_{\text{death}}(a)}{S_{\text{death}}(a - t)}
    & \text{if $a > t$}.
  \end{cases}
\end{equation}
...
\begin{equation}
  \begin{split}
    ...
    \\ & \quad {}
    - h_{\text{death}}(a_{i - 1 / 2}) \frac{R_i + R_{i - 1}}{2},
  \end{split}
\end{equation}
with boundary conditions
\begin{equation}
