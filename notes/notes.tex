...
\begin{equation}
  S_{\text{birth}}(t, a, t_0) = \exp\left(- H(t, a, t_0)\right),
\end{equation}
...
\begin{align}
  ...
  \begin{cases}
    ...
    & \text{if $a \geq 4 - t$ and $c_v < \frac{1}{\sqrt{3}}$},
    \\
    \mu \alpha \left(H_4 + H_5 + H_6\right)
    & \text{if $a \geq 4 - t$ and $c_v \geq \frac{1}{\sqrt{3}}$},
  \end{cases}
  \\
...
\end{align}
Binning by month gives the probability mass function
\begin{align}
  g(m, a, t_0) &=
  \int_0^1 f_{\text{birth}}\left(\frac{m + \mu}{12}, a, t_0\right)~\md
  \mu
  & & \text{for $m \in \{0, 1, 2, \ldots\}$}.
\end{align}
Then summing over years gives
\begin{align}
  \bar{g}(m, a, t_0) &= \sum_{y = 0}^{\infty} g(m + y, a, t_0)
  & & \text{for $m \in \{0, 1, 2, \ldots, 11\}$}.
\end{align}
...
\begin{equation}
  ...
  \begin{cases}
    0 & \text{if $a < 4 - t$},
    \\
    \alpha \int_{\ell}^t g(t_0 + \tau)~\md \tau & \text{if $a \geq 4 -
      t$},
  \end{cases}
\end{equation}
\begin{equation}
...
\begin{equation}
  ...
  \begin{cases}
    0 & \text{if $a < 4 - t$},
    \\
    \alpha \left(H_4 + H_5 + H_6\right) & \text{if $a \geq 4 - t$},
  \end{cases}
\end{equation}
with
\begin{align}
