\begin{tikzpicture}[
  ...
  \node at (2.5, 3.125) [compartment, name=Carrier] {Carrier};
  \node at (0, 2.5) [compartment, name=Recovered] {Recovered};
  \node at (0, 0) [compartment, align=center, dashed, name=LostImmunity] {Lost\\immunity};
  ...
  \draw [->, dashed] (Recovered.212)
             ...
             (LostImmunity.135);
  \draw [->, dashed] (LostImmunity.45)
             to node [rotate=-90, align=center] {antibody\\gain}
             (Recovered.328);
  \draw [->, dashed] (LostImmunity.153)
             to [out=135, in=225, looseness=0.65] node [sloped, below, pos=0.57] {secondary infection}
             (Exposed.200);
  % Births
